...
const frames = new Map([
    ...
    ['crack-4', [[[555, 244, 249, 81], [124, 28]], [-42, -112, 85, 113], [-42, -112, 85, 113]]],
...
const animations = {
    ...
    [FireballState.CRACK]: [
        ['crack-1', 10],['crack-2', 10],['crack-3', 10],['crack-4', 200],['crack-4', 100],
],
};
...
export class Rock {
    ...
    handleCollisionEffects(time, collisionState) {
        ...
        if (opponent.currentState === FighterState.WALK_BACKWARD || opponent.currentState === FighterState.BLOCK) {
            this.entityList.add(BlockHitSplash, time, opponent.position.x, opponent.position.y - 40, 1);
            opponent.changeState(FighterState.BLOCK, time);
           // this.direction *= -1;
           // this.directionY = 1;
        ...
        if (collisionState === FireballCollidedState.OPPONENT && this.canDealDamage) {
            ...
            opponent.position.y -= 100 * time.secondsPassed;
           // this.direction *= -1;
           // this.directionY = 1;
